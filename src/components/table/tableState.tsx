...
const TableResponsiveState: React.FC<TableProps> = ({ propClassNameOpcional, columns, data,  toggleStatus, itemsPerPage: defaultItemsPerPage = 5, toggleOptionalStatus, btnToggleOptionalStatus }) => {
...
export default TableResponsiveState;
