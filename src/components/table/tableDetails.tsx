...
import { faTimes, faCheck, faPenToSquare, faInfoCircle } from '@fortawesome/free-solid-svg-icons';
...
interface TableProps {
    ...
    openModal: (user: any) => void; // Función para abrir un modal de un elemento
    openModalDetalles: (user: any) => void;// Función para abrir un modal con los detalles de un elemento
                                            ...
                                            {column.actions ? (
                                                <div className='table-btn-container'>
                                                    {btnActionName === 'Detalles' ? (
                                                        <>
                                                            <button className='btn-info' onClick={() => openModal(item)}>
                                                                <FontAwesomeIcon icon={faInfoCircle} /> {btnActionName}
                                                            </button></>

                                                    ) : (
                                                        <>
                                                            <button className='btn-info' onClick={() => openModal(item)}>{btnActionName}
                                                            </button>
                                                        </>
                                                    )
                                                    }
