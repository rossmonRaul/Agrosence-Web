...
export const ObtenerManejoFertilizantes = async () => {
    const url = `${baseURL}/api/v1.0/${controlador}/ObtenerManejoFertilizantes`;
    return await ProcesarDatosApi('GET', url, '');
}

export const CambiarEstadoManejoFertilizantes = async (data: any) => {
    const url = `${baseURL}/api/v1.0/${controlador}/CambiarEstadoManejoFertilizantes`;
    return await ProcesarDatosApi('PUT', url, data);
}

export const InsertarManejoFertilizantes = async (data: any) => {
    const url = `${baseURL}/api/v1.0/${controlador}/InsertarManejoFertilizantes`;
    return await ProcesarDatosApi('POST', url, data);
}

export const EditarManejoFertilizantes = async (data: any) => {
    const url = `${baseURL}/api/v1.0/${controlador}/ActualizarManejoFertilizantes`;
    return await ProcesarDatosApi('PUT', url, data);
}